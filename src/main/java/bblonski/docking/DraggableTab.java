...
public class DraggableTab extends Tab {
     ...
     */
    public DraggableTab(String text, DockController controller) {
        ...
        nameLabel.setOnMouseDragged(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                ...
                controller.getTabPanes().add(getTabPane());
        ...
        nameLabel.setOnMouseReleased(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                ...
                if (!t.isStillSincePress()) {
                    ...
                    controller.getTabPanes().add(oldTabPane);
                    InsertData insertData = getInsertData(screenPoint, controller);
                    if (insertData != null) {
                    ...
                    controller.getTabPanes().add(pane);
                    newStage.setOnHiding(t1 -> controller.getTabPanes().remove(pane));
    ...
    private InsertData getInsertData(Point2D screenPoint, DockController controller) {
        for (TabPane tabPane : controller.getTabPanes()) {
